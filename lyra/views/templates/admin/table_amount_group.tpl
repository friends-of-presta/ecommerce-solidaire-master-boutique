...
<thead>
  <tr>
    <th>{l s='Customer group' mod='lyra'}</th>
    <th>{l s='Minimum amount' mod='lyra'}</th>
    {if !isset($min_only) || !$min_only}<th>{l s='Maximum amount' mod='lyra'}</th>{/if}
  </tr>
</thead>

<tbody>
  <tr style="background-color: #bebebe;">
    <td>{l s='ALL GROUPS' mod='lyra'}</td>
    <td>
