...
class LyraOneyPayment extends AbstractLyraPayment
{
    const ONEY_THREE_TIMES_MAX_FEES = 10;
    const ONEY_FOUR_TIMES_MAX_FEES = 20;

    protected $prefix = 'LYRA_ONEY_';
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('LYRA_ONEY_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['lyra_oney_options'] = $options;
