...
class LyraFullcbPayment extends AbstractLyraPayment
{
    const FULLCB_THREE_TIMES_MAX_FEES = 9;
    const FULLCB_FOUR_TIMES_MAX_FEES = 12;

    protected $prefix = 'LYRA_FULLCB_';
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('LYRA_FULLCB_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['lyra_fullcb_options'] = $options;
