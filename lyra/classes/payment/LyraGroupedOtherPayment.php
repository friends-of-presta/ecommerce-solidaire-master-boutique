...
class LyraGroupedOtherPayment extends AbstractLyraPayment
{
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['lyra_other_options'] = $options;
    ...
    public function prepareRequest($cart, $data = array())
    {
        ...
        $available_payments = LyraOtherPayment::getAvailablePaymentMeans($cart);
        $validation_mode = '-1';
        $capture_delay = '';
